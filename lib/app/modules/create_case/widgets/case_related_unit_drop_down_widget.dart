...
class CaseRelatedUnitDropDownWidget extends GetView<AddCaseController> {
  const CaseRelatedUnitDropDownWidget({Key? key}) : super(key: key);
            ...
            : GetBuilder<AddCaseController>(
                builder: (controller) => CustomDropDown(
                    ...
                    onChange: (newValue) async {
                      ...
                      Get.log(
                          '========== related Unit name : ${controller.relatedUnitValue.value?.name.toString()} ========');
                      controller.update();
                    },
