                                ...
                                Form(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Obx(() =>
                                            CustomCheckBox(
                                                value: controller.standardCheck
                                                    .value,
                                                onChanged: (bool? value) {
                                                  FocusScope.of(context)
                                                      .unfocus();
                                                  if (controller.urgentCheck
                                                      .isTrue) {
                                                    controller.urgentCheck
                                                        .value =
                                                    !controller.urgentCheck
                                                        .value;
                                                    controller.standardCheck
                                                        .value =
                                                    !controller.standardCheck
                                                        .value;
                                                  } else {
                                        ...
                                        Obx(() =>
                                            CustomCheckBox(
                                                value: controller.urgentCheck
                                                    .value,
                                                onChanged: (bool? value) {
                                                  FocusScope.of(context)
                                                      .unfocus();

                                                  if (controller.standardCheck
                                                      .isTrue) {
                                                    controller.standardCheck
                                                        .value =
                                                    !controller.standardCheck
                                  ...
                                  Obx(() =>
                                      Checkbox(
                                          ...
                                          onChanged: (bool? value) {
                                            ...
                                            controller.acceptResponsibilityCheck
                                                .value =
                                            !controller
                                                .acceptResponsibilityCheck
                                                .value;
