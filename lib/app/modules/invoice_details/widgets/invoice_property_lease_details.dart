...
class InvoicePropertyLeaseDetailsWidget
    extends GetView<InvoiceDetailsController> {
          ...
          Row(mainAxisAlignment: MainAxisAlignment.start, children: [
            Expanded(
                ...
                child: customDetailsItem(
                    ...
                    value: controller.invoice.advancedPropertyContractId ??
                        Strings.na)),
            Expanded(
                flex: 1,
                child: customDetailsItem(
                    ...
                    value: controller.invoice.statusCode != null
                        ? controller.invoice.statusCode.toString()
                        : Strings.na))
          ])
        ]));
  }
