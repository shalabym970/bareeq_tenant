...
class NewVersion {
  ...
  void showUpdateDialog({
    ...
    final dialogTitleWidget = Text(dialogTitle, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20.sp),);
    final dialogTextWidget = Text(
      dialogText ??
          'You can now update this app from ${versionStatus.localVersion} to ${versionStatus.storeVersion}',
    );

    final updateButtonTextWidget = Text(updateButtonText,style: TextStyle(color: Colors.blue[200],fontWeight: FontWeight.bold,fontSize: 15.sp));
    updateAction() {
    ...
    if (allowDismissal) {
      final dismissButtonTextWidget = Text(dismissButtonText,style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold,fontSize: 15.sp));
